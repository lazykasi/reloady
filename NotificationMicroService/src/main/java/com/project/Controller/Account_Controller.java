...
import com.project.service.Account_Service;
	...
	public ResponseEntity<Account> CreateAccount(@RequestBody Account account) {
		try {
			 if(account == null) {
				 ...
				 String subject = "your Account has been Created Successfully" + "User_Id :" + account.getId() + " User_Name" + account.getName() + " User_PhoneNo " + account.getPhone();
				 this.Mailservice.Mailsender(account.getEmail(),"Account_Detail",subject);
